...
def Astar(start_station_name: str,
    ...
    while len(queue) > 0:
        costs = {station_name: stations[station_name].distance + heuristic_function(station_name, end_station_name, map)
                 for distance, station_name in queue}
