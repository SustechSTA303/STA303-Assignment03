...
def get_path(start_station_name: str, end_station_name: str, map: dict[str, Station]) -> List[str]:
    ...
    f_score = {start_station: heuristic_cost_estimate_manhattan(start_station, end_station)}
    ...
    while open_set:
        ...
        if current_station == end_station:
            ...
            print(f"A* with Manhattan distance algorithm execution time: {elapsed_time} seconds")
            return path
        ...
        for neighbor in current_station.links:
            ...
            if neighbor not in g_score or tentative_g_score < g_score[neighbor]:
                ...
                f_score[neighbor] = tentative_g_score + heuristic_cost_estimate_manhattan(neighbor, end_station)
