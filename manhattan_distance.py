...
def get_path_m(start_station_name: str, end_station_name: str, map: dict[str, Station]) -> List[str]:
    ...
    open_set.put((0, manhattan_distance(start_station, end_station), start_station, [start_station]))
    ...
    while not open_set.empty():
        ...
        for neighbor in current_station.links:
            if neighbor not in closed_set:
                ...
                heuristic = manhattan_distance(neighbor, end_station)
                total_cost = new_cost + heuristic
                new_path = current_path + [neighbor]

                open_set.put((total_cost, heuristic, neighbor, new_path))

    return None,expanded_nodes, iterations  # No path fo
if __name__ == '__main__':
    ...
    path,expanded_nodes, iterations  = get_path_m(start_station_name, end_station_name, stations)
